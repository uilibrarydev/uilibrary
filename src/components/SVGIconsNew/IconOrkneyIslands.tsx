...
export const IconOrkneyIslands = ({
  size,
  className = '',
  onClick,
  refHandler,
  ...
  >
    <g clipPath="url(#clip0_3366_15178)">
      <path
      ...
      />
      <path
        d="M0.344498 12.6086C0.923091 14.7555 2.19833 16.6162 3.91305 17.9337V12.6086H0.344498Z"
        fill="#D80027"
      />
      <path
      ...
      />
      <path
        d="M3.91305 2.06616C2.19833 3.38374 0.923091 5.2444 0.344498 7.39124H3.91305V2.06616Z"
        fill="#D80027"
      />
      <path
...
export default IconOrkneyIslands
